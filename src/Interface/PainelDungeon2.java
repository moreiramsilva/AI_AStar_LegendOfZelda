...
public class PainelDungeon2 extends JPanel {
	...
	public PainelDungeon2() {
		// TODO Auto-generated constructor stub
	}

	public PainelDungeon2(ArrayList<Limites> movimento) {
	...
	private class ColorTableModel extends AbstractTableModel {
		...
		public void ColoreMapa(String arquivo) {
			...
			ImageIcon imgL = new ImageIcon("link.png");
			ImageIcon imgMS = new ImageIcon("Master Sword.png");
			ImageIcon imgPD = new ImageIcon("porta dungeon.png");
			ImageIcon imgPMS = new ImageIcon("porta Master.png");
			...
			color = new Color(0, 255, 0); // cor do pingente da sabedoria "VERDE"
			colors[2][13] = color;
			fireTableCellUpdated(2, 13);

			color = new Color(0, 0, 0); // preto da porta dungeon
			colors[26][13] = color;
			fireTableCellUpdated(26, 13);

			color = new Color(153, 50, 204); // roxo  representa o agente
			colors[25][13] = color;
			fireTableCellUpdated(25, 13);
	...
	private class RandomColorShadeRunnable implements Runnable {
		public void run() {
			tableModel.ColoreMapa("mapa_dg2.txt");
			int i=0;
			while (keepRunning) {
